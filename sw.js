const CACHE='pecl-offline-v3';
const FILES=['./','index.html','landing-page.html','pecl-form.html','PECL.doc','manifest.webmanifest','icon.svg','level-2/','level-4/','level-6/','level-7/','level-8/','https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js'];
